...
type FileTrans struct {
	...
	TransResolution       string   `json:"transResolution" form:"transResolution" gorm:"column:trans_resolution;comment:分辨率;size:255;"`
	...
	TransDrawtextPosition string   `json:"transDrawtextPosition" form:"transDrawtextPosition" gorm:"column:trans_drawtext_position;comment:跑马灯位置;size:255;"`
	TransDrawtextDuration string   `json:"transDrawtextDuration" form:"transDrawtextDuration" gorm:"column:trans_drawtext_duration;comment:滚动时长;size:255;"`
	TransDrawtextInterval string   `json:"transDrawtextInterval" form:"transDrawtextInterval" gorm:"column:trans_drawtext_interval;comment:滚动间隔;size:255;"`
