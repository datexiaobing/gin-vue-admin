...
type Options struct {
	//TimeOut               *int              `flag:"-rw_timeout"`
	//STimeOut               *int              `flag:"-stimeout"`
	...
	CodecV                *string           `flag:"-codec:v"`
	CodecA                *string           `flag:"-codec:a"`
	Filter                *string           `flag:"-filter:v"`
	Lavfi                 *string           `flag:"-lavfi"`
	I                     *string           `flag:"-i"`
	ForceKeyFrames                     *string           `flag:"-force_key_frames"`
