  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="1未下载2暂停下载3下载完成">
            
             <el-input v-model.number="searchInfo.videoDownloadStatus" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="名称" prop="videoTitle" width="120" />
        <el-table-column align="left" label="存储地址" prop="videoDownloadPath" width="120" />
        <el-table-column align="left" label="下载链接" prop="videoUrl" width="120" />
        <el-table-column align="left" label="封面" prop="videoPic" width="120" />
        <el-table-column align="left" label="1未下载2暂停下载3下载完成" prop="videoDownloadStatus" width="120" />
        <el-table-column align="left" label="总大小" prop="videoSize" width="120" />
        <el-table-column align="left" label="已下载大小" prop="videoDownloadSize" width="120" />
        <el-table-column align="left" label="下载速率" prop="videoDownloadSpeed" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateVideoListFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="总大小:"  prop="videoSize" >
          <el-input-number v-model="formData.videoSize"  style="width:100%" :precision="2" :clearable="true"  />
        </el-form-item>
        <el-form-item label="已下载大小:"  prop="videoDownloadSize" >
          <el-input-number v-model="formData.videoDownloadSize"  style="width:100%" :precision="2" :clearable="true"  />
        </el-form-item>
        <el-form-item label="下载速率:"  prop="videoDownloadSpeed" >
          <el-input-number v-model="formData.videoDownloadSpeed"  style="width:100%" :precision="2" :clearable="true"  />
        </el-form-item>
      </el-form>
      <template #footer>
